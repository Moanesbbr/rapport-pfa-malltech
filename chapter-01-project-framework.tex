...
\textbf{Malltech} is a Tunisian company specialized in selling technological products such as smartphones, accessories, electronics, and various tech equipment. The objective of this project is to design and develop a complete e-commerce platform for Malltech, allowing the company to strengthen its digital presence and modernize the management of its commercial activities.

The platform consists of two main parts: a customer-facing e-commerce website and a complete management backoffice. The e-commerce website enables customers to browse products, search by categories, manage carts and wishlists, place orders securely, and follow their purchases through a modern and responsive interface.

The backoffice provides administrators and employees with a centralized management system for handling products, inventory, orders, customers, categories, promotions, website content, and business operations. It also includes tools for analytics, reporting, SEO management, and role-based access control to facilitate daily administrative tasks and improve operational efficiency.

The platform targets two main audiences:

\begin{itemize}
    \item \textbf{Customers} — who can explore Malltech products, place online orders, manage their accounts, and benefit from a seamless shopping experience.

    \item \textbf{Administrators and employees} — who can manage the entire e-commerce activity through a secure and comprehensive backoffice dashboard.
\end{itemize}

In addition to standard e-commerce functionalities, the platform integrates advanced features such as Search Engine Optimization (SEO), dynamic content management, analytics and reporting modules, and scalable management tools. The goal of the project is to provide Malltech with a modern digital solution capable of improving customer experience, optimizing internal management processes, and supporting the company's business growth.

\section{Study of Existing Solutions}

Before designing Malltech, a comparative analysis of available platforms was conducted:

\begin{longtable}{|m{2.5cm}|m{1.8cm}|m{4.8cm}|m{5.2cm}|}
    \hline
